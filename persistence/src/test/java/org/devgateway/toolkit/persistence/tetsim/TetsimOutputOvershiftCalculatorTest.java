...
public class TetsimOutputOvershiftCalculatorTest extends TetsimOutputBaseCalculatorTest {
    ...
    @Test
    public void testConsumptionLegalWithTaxChange1() {
        TetsimOutputCalculator tetsimOutputCalculator = new TetsimOutputOvershiftCalculator(datasetWithAllTobaccoProducts, 1);
        TetsimOutput output = tetsimOutputCalculator.calculate(POPULAR);
        assertEquals(750.27, output.getLegalConsumption(), delta, "Check Consumption Legal TETSIM Output Overshift (Tax Change)");
    }
